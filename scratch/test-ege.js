...
async function testUrl(url) {
  ...
  try {
    ...
    fs.writeFileSync(path.join(__dirname, 'ege-output.html'), text, 'utf8');
    ...
    // Look for link structures or images
    const links = [];
    ...
    while ((match = linkRegex.exec(text)) !== null) {
      ...
      if (href.includes('/urun/') || href.includes('/urunler/') || href.includes('koleksiyon') || href.includes('detail')) {
...
testUrl('https://www.egeseramik.com/urunler');
