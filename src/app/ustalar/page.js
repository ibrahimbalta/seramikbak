    ...
    <div style={{ minHeight: '100vh', background: '#090d16', color: '#f8fafc', fontFamily: 'Inter, system-ui, sans-serif' }}>
      ...
      <header style={{
        ...
        <div style={{
          ...
          <Link href="/" style={{ display: 'flex', alignItems: 'center', gap: '10px', textDecoration: 'none' }}>
            ...
            <span style={{ fontSize: '1.2rem', fontWeight: '900', color: '#ffffff' }}>SeramikBak <span style={{ color: '#d4af37', fontSize: '0.85rem' }}>USTA REHBERİ</span></span>
          </Link>
      ...
      <section style={{
        ...
        <div style={{ maxWidth: '840px', margin: '0 auto' }}>
          <div style={{
            ...
            <ShieldCheck size={14} />
            81 İLDE ONAYLI SERAMİK USTA VE UYGULAMA DİZİNİ
          </div>
          ...
          <p style={{ fontSize: '0.98rem', color: '#cbd5e1', lineHeight: '1.6', margin: '0 0 28px 0' }}>
      ...
      <main style={{ maxWidth: '1280px', margin: '0 auto', padding: '40px 24px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
          <div>
            <h2 style={{ fontSize: '1.4rem', fontWeight: '800', margin: '0 0 4px 0', color: '#ffffff' }}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '12px' }}>
                      <div>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' }}>
                          <h3 style={{ fontSize: '1.15rem', fontWeight: '900', color: '#ffffff', margin: 0 }}>{inst.name}</h3>
                          {inst.verified && (
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
              ...
              <div>
                <h3 style={{ fontSize: '1.2rem', fontWeight: '900', color: '#ffffff', margin: 0 }}>Usta Kayıt Formu</h3>
            ...
            {regSuccess ? (
              ...
              <form onSubmit={handleRegisterInstaller} style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
                {regError && (
                ...
                <div>
                  ...
                  <input
                    type="text"
                    placeholder="Örn: 60x120 Karo, Banyo Seramiği, Derz & Su İzolasyonu"
                ...
                <div>
                  ...
                  <textarea
                    rows={2}
                    placeholder="Ekip mevcudunuz, lazerli terazi tecrübeniz veya iş teslim garantiniz gibi detayları yazabilirsiniz..."
                    value={regNotes}
