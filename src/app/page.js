            ...
            <div className="main-search-and-results-layout">
              ...
              <aside className="filters-sidebar-new glass-panel" style={{ position: 'relative' }}>
                ...
                <div className="filter-group-new">
                  ...
                  <button onClick={() => setSelectedSize('')} className="show-all-filter-link" style={{ marginTop: '8px' }}>Tümünü Göster</button>
                </div>
                ...
                <div className="filter-group-new select-group">
                  <h4 className="filter-group-title">Yüzey</h4>
                  <select className="simple-filter-select" value={selectedFinish} onChange={(e) => setSelectedFinish(e.target.value)}>
                    ...
                    <option value="Parlak">Parlak (Camsı)</option>
                    <option value="Lapatto">Lapatto (Yarı Parlak)</option>
                  </select>
                </div>
              </aside>
              ...
              <div className="results-container-new">
                <div className="results-header-row-new">
                  <div className="results-header-text-new">
                    {uploadedImagePreview ? (
                      <>
                        ...
                        <p>Yüklediğiniz görselle benzer doku ve renkteki ürünler listeleniyor.</p>
                      </>
                    ) : (
                      <>
                        <h3>Yeni Eklenen Ürünler <span className="results-new-badge">Yeni</span></h3>
                        <p>En yeni seramik koleksiyonlarını keşfedin.</p>
                      </>
                    )}
                  </div>
                  <div className="results-header-actions-new">
                    ...
                    }} className="view-all-results-link">Temizle / Tümünü Gör</button>
                    <div className="results-slider-arrows-new">
                      <button className="slider-arrow-btn-new">❮</button>
                      <button className="slider-arrow-btn-new">❯</button>
                    </div>
                  </div>
                </div>
